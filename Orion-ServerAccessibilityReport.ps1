...
"**** SERVER ACCESSIBILITY REPORT ****<br>"                | Out-File -Append $emailBody
"Orion's Server List Date:<br>"                            | Out-File -Append $emailBody
"$orionDate<br>"                                           | Out-File -Append $emailBody
"<br>"                                                     | Out-File -Append $emailBody
"-- NOT ACCESSIBLE --<br>"                                 | Out-File -Append $emailBody

foreach ($line in Get-Content $offlineList) {
    "$line<br>"                                            | Out-File -Append $emailBody
}

"<br>"                                                     | Out-File -Append $emailBody
"-- ACCESSIBLE --<br>"                                     | Out-File -Append $emailBody
...
"<br>"                                                     | Out-File -Append $emailBody
"**** END OF REPORT ****<br>"                              | Out-File -Append $emailBody
"<br>"                                                     | Out-File -Append $emailBody
"Path for Server List pickup is:<br>"                      | Out-File -Append $emailBody
"$inputFile<br>"                                           | Out-File -Append $emailBody
"<br>"                                                     | Out-File -Append $emailBody
"Email autogenerated from $(hostname) in $runningTime<br>" | Out-File -Append $emailBody
